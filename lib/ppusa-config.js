...
const config = Object.freeze({
  ...
  navTimeout: Number(getEnv('PPUSA_NAV_TIMEOUT_MS', '8000')) || 8000, // Reduced from 20s to 8s
  debug: String(getEnv('PPUSA_DEBUG', 'false')).toLowerCase() === 'true',
  userAgent: getEnv('PPUSA_LOGIN_UA', DEFAULT_UA),
  cookieUserAgent: getEnv('PPUSA_COOKIE_UA', ''),
  acceptLanguage: getEnv('PPUSA_ACCEPT_LANGUAGE', 'en-US,en;q=0.9'),
  timezone: getEnv('PPUSA_TZ', ''),
});
