...
const BYPASS_USER_ID = process.env.BYPASS_USER_ID || ALLOWED_DM_USER || '1430928325890670623';
...
const DEBUG_USER_IDS = DEBUG_USERS_ENV
  ...
  : (ALLOWED_DM_USER ? [ALLOWED_DM_USER, '1430928325890670623'] : ['1430928325890670623']);
